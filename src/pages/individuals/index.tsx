...
export function IndividualListPage(props: IndividualListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('backlink', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'backlink',
          header: 'Backlink',
          accessorKey: 'backlink',
          cell: ({ row: { original: record } }: any) => record?._count?.backlink,
        }
      : null,
