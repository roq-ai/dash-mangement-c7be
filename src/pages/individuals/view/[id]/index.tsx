...
import { BacklinkListPage } from 'pages/backlinks';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('individual', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/individuals/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="individual" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
