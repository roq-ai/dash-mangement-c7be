...
-- AddForeignKey
ALTER TABLE "backlink" ADD CONSTRAINT "backlink_individual_id_fkey" FOREIGN KEY ("individual_id") REFERENCES "individual"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
